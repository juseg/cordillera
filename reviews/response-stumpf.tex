...
\referee{%
    ...
    \citealp[e.g.,][]{Plouffe.Jette.1997}). I applaud them for undertaking of such a
...
\referee{%
    ...
    test against the modeling. \citet{Stumpf.etal.2014} provides a list of some of
    these studies.}
...
\referee{%
    ...
    \citep[e.g.,][]{Ferbey.etal.2013} to constrain ice divide positions, ice flow direction,
    and ice sheet thickness?}

\referee{%
    4) For the central sector of the CIS, \citet{Stumpf.etal.2000} provides some
