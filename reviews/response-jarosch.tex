...
\referee{%
    ...
    this manuscript. This evaluation \citep{Jarosch.etal.2012} demonstrated
    ...
    the Rocky Mountains. \citet{Jarosch.etal.2012} further concluded that
    ...
    and reflect their arguments with the findings of \citet{Jarosch.etal.2012}.
...
choices clear, we have included all default parameters values mentioned
...
\referee{%
    ...
    \citep{Jarosch.etal.2012} that the NARR precipitation fields do not contain
    ...
    fields down to about 1\,km grid sizes \citep{Jarosch.etal.2012}. Taking
    ...
    \citet{Jarosch.etal.2012}. Temperature however is better constrained in
    NARR \citep{Jarosch.etal.2012} and contains spectral information down to
...
downscaling techniques can correct for errors caused by resolution gap. We have
rephrased this sentence to highlight this.
