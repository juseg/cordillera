...
co-authors, the fundamental challenge you refer to is to communicate to each
community using their own slang and their methods to describe the results. 
...
ice flow parameters. Thus the new outline is now as follows:
%
\begin{enumerate}
    \item{Introduction}
    \item{Model setup}
...
\end{enumerate}
%
In accordance, Sect.~2 (Model setup) will be amended with a description of
...
has been expanded and divided into:
%
\begin{enumerate}
