...
modelled ice extent in agreement with the regional geomorphology), and P4171
L7, L9, L17, L19 and L20 (discussion of the modelled flow patterns and the
observed lineation pattern on Interior Plateau of British Columbia) is
intentional. So is our choice to discuss some aspects of the model results that
are not unequivocal, as a result of uncertain model parameters (as partly
addressed by our new sensitivity study) or, more often, due to processes not
...
This is not only to prevent over-interpretation of our model results by
researchers with little or no background in ice sheet modelling, but also to
hint at potential model improvements that may be needed to approach these
debates through numerical modelling. Thus we do not plan to shorten section~4.
