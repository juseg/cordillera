...
\referee{%
    \textbf{P4151 L11-16:}
    In this sentence the authors refer back to their previous work
    \citep{Seguinot.etal.2014} and highlight that the NARR temperature and precipitation
    ...
    gradients which are required as identified by et \citet{Seguinot.etal.2014}.
    ...
    representation of the existing topography on a 32\,km grid. \citet{Seguinot.etal.2014}
    have partly discussed that however. NARR precipitation and
    ...
    This evaluation \citep{Jarosch.etal.2010} demonstrated that NARR has
    ...
    Mountains. \citet{Jarosch.etal.2010} further concluded that physics based
    ...
    reflect their arguments with the findings of \citet{Jarosch.etal.2010}. A
...
\referee{%
    ...
    ice to ice viscosity \citep[see][equations 62-65)]{Aschwanden.etal.2012}. The
...
\referee{%
    ...
    manuscript. It has been demonstrated by spectral power analysis \citep{Jarosch.etal.2010}
    that the NARR precipitation fields do not contain any
    ...
    discuss their choice in the light of the findings from \citet{Jarosch.etal.2010}.
    Temperature however is better constrained in NARR \citep{Jarosch.etal.2010}
    and contains spectral information down to 10\,km resolution, which
