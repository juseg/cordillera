...
\begin{itemize}
    ...
    \item{Our \emph{soft ice} configuration include rheologic parameters,
          ...
          recommended value by \citet[p.~77]{Cuffey.Paterson.2010} for ice age
          polar ice.}
\end{itemize}

The effect of these three different parametrisations on temperature-dependent
ice softness, $A$, are illustrated in Fig.~\ref{fig:sens_plot_rheo}.
