...
\begin{figure}
  ...
  \caption{Density maps showing a~comparison of winter (DJF) precipitation rate from the WorldClim climatology, against that of each reanalysis, after bi-linear spatial interpolation. Colour mapping is based on a~logarythmic scale. Note the wet bias of all reanalysis data relative to WorldClim data.}
