...
\begin{figure}
    ...
    \caption{Summer temperature difference maps, as in paper Fig. 9, with a new colour scale.}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=70mm]{cordillera-climate-tempdiff}
    \caption{Summer temperature difference maps, after applying a lapse-rate correction.}
\end{figure}
