...
During most of the the last glacial cycle, glaciers and ice caps of the North
American Cordillera were more extensive than today. At the Last Glacial
Maximum (LGM), a continuous blanket of ice, the Cordilleran ice sheet
\citep{Dawson.1888}, extended from the Alaska Range in the north to the
North Cascades in the south. It calved into the Pacific Ocean in the west, and
merged with the Laurentide ice sheet in the east (Fig.~\ref{fig:locmap}).

For more than a century, exploration and geological investigations of the
...
the south-western and north-eastern margins provide key constraints that
allow reasonable reconstructions of the maximum ice extent
    (\citealp{Prest.etal.1968}; \citealp[Fig. 1.12]{Clague.1989};
     \citealp{Duk-Rodkin.1999};
     \citealp{Booth.etal.2003}; \citealp{Dyke.2004}).
The timing of the last glaciation, reconstructed from radiocarbon dating
...
bedrock deformation in response to the ice load
    \citep{Clague.James.2002, Clague.etal.2005},
and the offshore sedimentary record
    \citep{Cosma.etal.2008, Davies.etal.2011}
indicate that the LGM ice-sheet was short-lived. However, former ice thickness
and, therefore, the ice sheet's contribution to the last glacial maximum sea
level low stand
...
In parts of the Yukon Territory and Alaska, dated glacial erratics indicate
an extensive Marine Isotope Stage (MIS)~4 glaciation
    \citep{Ward.etal.2007, Ward.etal.2008, Briner.Kaufman.2008,
           Stroeven.etal.2010, Stroeven.etal.2014},
yet it is not known whether other regions were affected. Lineation patterns in
the ice sheet interior include flow directions likely older than the LGM
    \citep[Fig.~2]{Kleman.etal.2010},
but their absolute age is uncertain.

In contrast, our understanding of the deglaciation history of the Cordilleran
ice sheet since the LGM is considerable, albeit mostly at a regional scale.
Geomorphological evidence from south-central British Columbia suggests a rapid
deglaciation, including early emergence of the high-elevated areas and
stagnation of thin ice cover in the lowlands
    \citep{Fulton.1967, Fulton.1991, Margold.etal.2011, Margold.etal.2013a},
yet this model may not apply in all areas of the Cordilleran ice sheet
    \citep{Margold.etal.2013}.
Finally, disparate clues for a late-glacial re-advance have been found in the
Coast, Columbia and Rocky Mountains
    \citep{Clague.etal.1997, Friele.Clague.2002, Friele.Clague.2002a,
           ...
           Menounos.etal.2008},
but the evidence is much more sparse than that of regions surrounding the North
Atlantic \aref, thus leaving space for debate around the possibility of a
regional late-glacial cold reversal.

In general, the topographic complexity of the Cordillera has not allowed for
ice-sheet wide reconstructions of glacial advance and retreat patterns such as
those available for the Fennoscandian and Laurentide and ice sheets
...
reconstruction of the ice sheet history through the last glacial cycle, and
...
\begin{itemize}
  ...
  \item Which were the primary dispersal centres? Do they reflect a stable or
    ephemeral configuration?
  \item What was the scale of glaciation prior to the last glacial maximum?
  \item How rapid was the deglaciation? Did it include stand-stills or
    re-advances?
\end{itemize}
...
ago (\citealp[p.~227]{Jackson.Clague.1991}; \citealp{Robert.1991},
...
over millenial time scales \citep{Golledge.etal.2012}. Second, the complex
...
including time-evolved temperature and precipitation fields derived from a
combination of a present-day atmospheric reanalysis \citep{Mesinger.etal.2006},
