...
a~temperature-index model \citep[e.g.,][]{Hock.2003}\renote{
...
\emph{[\textbf{About the new titles}: In my view, this
    ...
    climate forcing time-series'', which is actually what that section is
...
Independently of the palaeo-temperature records\renote{
    In my view, ``climate forcing'' would be far too broad here. We
    could possibly apply a much wilder choice of climate forcing
...
over the western margin of the Fraser Plateau\footnote{
    Just checked that this name is correct. Feels lighter than the ``Interior
    Plateau of south-central British Columbia'' (although having a slightly
    different meaning).}
...
results, this perhaps appears indicate that\renote{
...
deglaciation, and that deglacial landforms are largely absent. Alternatively,
local geothermal heat associated with volcanic activity on the Fraser Plateau
could have triggered the basal sliding \citep{Fahnestock.etal.2001}.
...
\begin{figure}
  ...
  \caption{Relief map of northern North America showing a reconstruction of the
           ...
           Mountains (RM) and the North Cascades (NC). Major depressions
           ...
           \todo{Mark palaeo-ice sheets, mountain ranges and depressions on
                 the map. Dash boundaries between ice sheets?}}
  \label{fig:locmap}
\end{figure}
...
\begin{figure*}
  ...
  \caption{Modelled duration of ice cover during the last 120\,ka.
           ...
           \todo{Add WSE, SMK, NR, NC mountain ranges, and change kyr to ka}}
  \label{fig:duration}
\end{figure*}
...
\begin{figure*}
  ...
  \caption{Modelled fraction of warm-based ice cover during the ice-covered
           ...
           Hatches indicate areas that were covered by cold ice only.
           \todo{indicate location of the Skeena Mountains and the MacKenzie
                 Mountains.}}
  \label{fig:warmfrac}
\end{figure*}
...
\begin{figure*}
  ...
  \caption{Snapshots of modelled surface topography (200\,m contours)
           ...
           \todo{Add the location of profiles used in
                 Figs.~\ref{fig:profiles-grip} and~\ref{fig:profiles-grip}.}}
...
\begin{figure*}
  ...
  \caption{Modelled directions of the deglacial basal flow velocities. Hatches
           ...
           (22.0--8.0\,ka), notably including the Fraser Plateau.
           Sliding grid cells were distinguished from non-sliding grid cells
           using a velocity threshold of 1\,\unit{m\,yr^{-1}}.
           \todo{indicate the Fraser Plateau and the Liard Lowland. Add the
                 location of profiles used in Figs.~\ref{fig:profiles-grip}
                 and~\ref{fig:profiles-grip}.}}
  \label{fig:lastflow}
\end{figure*}
...
\begin{figure}
  ...
  \caption{Modelled bedrock (black) and ice surface (blue) topography profiles
           ...
           Fig.~\ref{fig:deglac}.
           \todo{indicate mountain ranges and depressions.}}
