...
\subsection{Evolution of ice volume}
      ...
      panel). A sea-level relevant ice volume minimum is consistently
...
\label{sec:sens}
      ...
      to ice rheology of 25\,\unit{\%}, and an even more important
      ...
      relevant ice volume
      during the MIS~2 (LGM) varies by 25\,\unit{\%} between the two
...
\label{sec:mis2}
      ...
      The easterly position of the modelled ice divide and eastern ice sheet
      margin may also reflect the fact that our model does not include
      feedback mechanisms between ice sheet topography and the regional
      climate since it assumes fixed modern-day spatial patterns for
      temperature and precipitation. In fact, it is reasonable to think
