...
\renote{
    ``Monthly climatology'' is a common term in meteorology to design a set
...
that results in a larger ice volume during MIS~4 than during the LGM (MIS~2).
...
Finally, model runs forced by Antarctic palaeo-temperature records results in a
rapid an uninterrupted deglaciation after the last glacial maximum, whereas the
simulation driven by the GRIP palaeo-temperature record also result in a rapid
...
all the model runs show relatively consistent patterns of glaciation
...
simulation to the next. They include a ca. 1500\,km-long central divide
located about 3500\,m\ above sea level (a.s.l.) along the spine of the Rocky
...
(Fig.~\ref{fig:duration}). A 2500\,km-long continuous ice cover spanning from
