...
\label{sec:timing}
      ...
      here; instead we focus on simulations forced by palaeo-temperature
...
\subsubsection{Erosional imprint on the landscape}
      ...
      the Coast Mountains, the Columbia and Rocky mountains, the Wrangell
...
\subsubsection{Deglacial flow directions}
      ...
      LGM ice sheet being too far to the east (Sect.~\ref{sec:mis2};
...
\begin{figure*}
  ...
  \caption{Modelled surface topography (200\,\unit{m} contours) and surface velocity
...
\begin{figure*}
  ...
  \caption{Modelled duration of ice cover during the last 120\,\unit{ka} using GRIP
