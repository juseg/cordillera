...
$\{T_{m0}, P_{m0}\}$, modified by temperature-offset time series
${\Delta}T_{TS}$ and a lapse-rate correction ${\Delta}T_{LR}$.
\begin{align}
    T_m(t, x, y) &= T_{m0}(x, y) + {\Delta}T_{TS}(t) + {\Delta}T_{LR}(t, x, y) \\
    P_m(t, x, y) &= P_{m0}(x, y)
\end{align}

The present-day climatology $\{T_{m0}, P_{m0}\}$ was computed from the
...
hand, and for differences between the the ice flow model basal topography
$z_{b}$ and the climate forcing reference topography $z_{ref}$ on the other
...
evidence in the northern parts of the model domain, and to the Fraser (MIS~2)
...
timing reconstructed from geological evidence is only attained by some of the
simulations. According to radiocarbon dating, the last glacial maximum advance
of the southern Cordilleran ice sheet margin has been constrained between
00.0\,\unit{kyr} and 00.0\,\unit{kyr}. These dates have been confirmed by the
offshore sediment record, which shows an increase of xxx
betweem 00.0\,\unit{kyr} and 00.0\,\unit{kyr}.
...
current \aref. The California currents is a southwards current driving cold
waters along the western coast of USA. It is thought to have weakened in the
presence of the Cordilleran ice sheet, explaining paradoxically warmer
sea-surface temperatures at the location of the ODP~1012 and ODP~1020 sites
during the last glacial maximum \aref.

This precocious glacial maximum illustrates
