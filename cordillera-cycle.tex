...
\begin{abstract}
  ...
  marine isotope stages~4 (61.9--55.4\,\unit{kyr}) and~2
  (29.5--16.9\,\unit{kyr}). The timing of glaciation is
...
consistently attained during MIS~3 (52.2--45.6\,\unit{kyr}). However, the
...
reach a last glacial maximum in ice volume between 19.5 and 16.9\,\unit{kyr},
...
deglaciation prior to 20\,\unit{kyr} due to a local temperature maximum that is
inconsistent with all other records used. The ODP~1020 simulation predicts an
early last glacial maximum in ice volume at 29.5\,\unit{kyr}, followed by
...
Mountains exists for about 29\,\unit{kyr} in total over MIS~2 and~4.
...
volume at 19.1\,\unit{kyr}, and produces a deglaciation in three steps,
including the first stand-still between 16.6 and 14.5\,\unit{kyr}, and a late
...
Columbia, are completely deglaciated by 12\,\unit{kyr}, whereas significant
