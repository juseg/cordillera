...
glacial cycle \citep{Clague.1989, Dyke.2004}. However, former ice thickness
...
the last glacial maximum extent \citep{Kleman.etal.2010}. Although
...
\citep{Prest.etal.1968, Clague.1989}, but remain poorly understood
...
ago \citep{Jackson.Clague.1991,Robert.1991}, the ubiquitously mountainous
...
terrain over millenial time scales \citep{Golledge.etal.2012}. In the North
...
sediment cores \citep{Herbert.2001}. Model output is compared to
...
from an Antarctic ice stream \citep{Tulaczyk.etal.2000}. Basal topography is
...
Reanalysis (NARR) \citep{Mesinger.etal.2006}, after excluding variability
associated with the seasonal cycle itself \citep{Seguinot.Rogozhina.2014}. The
...
shore \citep{Herbert.2001}. Palaeo-temperatures from the GRIP and NGRIP records
were calculated using a quadratic equation \citep{Johnsen.etal.1995},
\begin{equation}
...
current \citep{Herbert.2001}. The California current, driving cold waters southwards
...
during the last glacial maximum \citep{Herbert.2001}.
