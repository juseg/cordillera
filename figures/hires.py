...
sn_fig = iplt.gridfigure((25.0, 50.0), (len(records), 3), axes_pad=2.5*mm,
...
for i, rec in enumerate(records):
    ...
    for j, t in enumerate(snapindexes):
        ...
        iplt.icemargincontour(nc, t, colors='white', alpha=0.50)
        iplt.icemargincontour(nc, t)
    
        # draw surface topography contours
        iplt.surftopocontour(nc, t, levels=range(250, 5000, 250), linewidths=0.2)
...
sn_fig.savefig('hires-snapshots.png')
