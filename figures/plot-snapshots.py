...
# initialize figure
figw, figh = 170.0, 70.0
fig = plt.figure(0, (figw/25.4, figh/25.4))
ax = fig.add_axes([2.5/figw, 5.0/figh, 155.0/figw, 30.0/figh])
...
# add image grid
rect = [2.5/figw, 37.5/figh, 160.0/figw, 30.0/figh]
grid = ImageGrid(fig, rect, (1, len(tkalist)), axes_pad=2.5/25.4,
                 cbar_pad=2.5/25.4, cbar_size=2.5/25.4,
