...
arrangement of mountain ranges and interior basins. It was formed during
multiple accretion phases associated with the closure of several back-arc
oceanic trenches over a 200\,Ma-long geological history \mref.

Most of the dominant reliefs are found along two major strips that run parallel
to each other along the general orientation of the Cordillera
\cref{fig:map-cordillera}. The western strip consists of the Pacific Coast
orogenic belt \mref. Major ice-covered reliefs include,
from North to South, the Alaska Range, the Wrangell and Saint-Elias Mountains,
the Coast Mountains and the North Cascades. The eastern strip consists of the
...
The Cordillera comports several intermontane basins that impacted patterns
...
between around 10\,\degC\ along most of the Pacific Coast to above 40\,\degC\
in the polar interior. This concerns most of the area above 60\degree~N, and
