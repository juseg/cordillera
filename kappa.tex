...
The two older episodes, often referred to as Reid
and pre-Reid, are older than the last glacial cycle, and thus beyond the
scope of this study. The two younger glaciations, though, occurred both during
the last glacial cycle. Indeed, the Cordilleran ice sheet did not keep
...
first expansion cycle, the Gladstone glaciation, reached its maximum between
...
Isotope Stage (MIS)~4. However, evidence for the Gladstone glaciation has
...
built end moraines with oldest minimum apparent exposure ages of
$15.7\pm1.5$ and $17.7\pm1.6$\,\unit{^{10}Be\,ka} \citep{Stroeven.etal.2014},
which corresponds to the last global ice volume maximum
...
known as the Fraser glaciation, with a maximum extent framed between
...
McConnell and Fraser glaciation correspond to the same glacial episode, which
