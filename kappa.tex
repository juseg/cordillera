...
and extending as far south as Chicago and the Great Lakes. The Laurentide ice
sheet, largest of the three ice sheets, was centred on the modern Hudson Bay,
...
the Western Cordillera, our region of focus in the present thesis.
...
In North American, the Western Cordillera forms a broad mountain system with an
average east-west width of a about 1000\,km. Its topography is a complex
arrangement of mountain ranges and intramontane basins. It was formed during
multiple accretion phases associated with the closure of several back-arc
oceanic trenches over a 200\,Ma-long geologic history.

Most of the major reliefs are found along two major bands that run parallel to
each other along the general orientation of the Cordillera. The western band
consists of the Pacific Coast orogenic belt. Major ice-covered reliefs include,
from North to South, the Alaska Range, the Wranglell and Saint-Elias Mountains,
the Coast Mountains and the North Cascades. The eastern band consists of the
Nevadan and Laramide belts, which are separated by the deep and strikingly
rectilinear Rocky Mountain / Tintina Trench. It includes the Selwyn and Mac
Kenzie Mountains to the north, and the Rocky Mountains to the South. The brooks
range, in northern Alaska, has been glaciated but its glaciers were not
connected to the main body of the Cordilleran ice sheet.

The Cordillera comports several intermontane bansins, which, as we will see
further, host particular climate properties and significantly impacted patterns
of ice sheet flow. The two major depressions are the Interior Plateau of
central British Columbia, and the Liard Lowland. Between these two basins is
found a mildly elevated, but extensive and deeply incised mountain group known
as the Skeena Mountains.

The ubiquitously mountainous topography of the region presents a serious
obstacle to reconstructing past glacier dynamics in the Cordillera. Because of
...
the major topographical troughs, and sometimes flowing across them. In terms of
numerical glacier modelling, it implies complex patterns of flow and stress
...
distinctive patterns of temperature and precipitation over the model domain.
Due to the large latitudinal extent of the region, mean annual temperatures
vary between -12 and 12\,\degC. About half the model domain has a mean annual
temperature below freezing. However, seasonality, here computed as the
temperature difference between the warmest and the coldest months, varies
between around 10\,\degC along most of the Pacific Coast to above 40\,\degC in
the polar interior. This concerns most of the area above 60\degree~N, and
high-elevated mountain ranges below this latitude. There exist a partial
correlation between cold regions and those that have a large seasonality, so
that many regions where mean annual temperatures are well below freezing point
do experience warm summers.

Annual precipitation varies between less than half-a-meter in some of the
interior areas to several meters in some parts of maritime Alaska.
Precipitation rates are highest on the western slopes of the Pacific Coast
ranges and decline quickly on the other side of the mountains. In terms of ice
sheet mass balance, this contrast is even reinforced by the difference in
timing of the precipitation peak through the year. Coastal regions experience
most precipitation during winter and fall, thus as snow. On the contrary, many
inland regions experience dry winters and most of the annual precipitation
consequently falls as rain during the ablation season. The climatic setting of
the North American Cordillera is described further in \CCLI, where its effects
on the ice sheet model have been studied in detail.
...
The Cordilleran ice sheet covered most of the Canadian Cordillera, as well
ajacent some of the adjacent land in north-western contiguous USA and Alaska.
The southern margin is the one that has been most studied. It consisted of
different ice lobes, that have formed at the exutory of the main valleys. The
Puget lobe was the westernmost and largest of these lobes. It covered the Puget
Lowland, a region that includes the current location of the cities of Vancouver
and Seattle. To the East of the Cascade Range were found the Okanagan and
Purcell lobes. The latter once dammed the Clark Fork River to form Glacial Lake
Missoula. As the ice sheet retreeted, the lake repeatedly and catastrophically
drained to the Pacific Ocean, forming on curse of the flood a lanscape now
...
continent. A large portion of the ice flow thus has engulfed between Vancouver
Island and the Olympic Peninsula, where it could find an exutory to the Pacific
Ocean, at the Juan the Fuca Lobe. Further to the North, the ice margin reached
Queen Charlotte Islands, yet the archipelago may not have been covered by ice
flowing from the land. Submarine troughs likely idicate the erosional action of
former ice streams, yet it is not clear wether they have formed during the last
glacial cycle or earlier.
...
ice sheet, certainly our largest assumption consists in neglecting butressing
effects from the Laurentide ice sheet.

Although the last glacial maximum extent of the Cordilleran ice sheet, apart of
its eastern margin, is relatively well known, the history of deglaciation is
heavily debated, while little information exists on earlier dynamics of ice
sheet.
