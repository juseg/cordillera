...
some of the forcing data. All co-authors contributed to improve the text.
...
Neglecting atmospheric pressure, \Cref{eqn:siaz} yields \todo{detail}
\begin{equation}
    p = \rho g (s-z) \,,
\end{equation}
...
\todo{explain why it is possible to linearly relate melt and PDDs.}
...
near-surface air temperature, $\sPDD$ (\cref{eq:calovgreve,
tab:surfaceparams}). Although the first two can only be deduced from surface
mass-balance measurements on present-day glaciers
