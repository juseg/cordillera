...
\begin{figure}
  ...
  \caption{Effect of temperature variability on Cordilleran ice sheet
           ...
           including
           \textbf{(a)} no daily variability, $\sigma=0$;
           \textbf{(b)} a constant, mean summer (JJA), model domain-averaged 
           standard deviation value, $\sigma=3.09$\,K;
           ...
           parametrisation in \PSDP, ${\sigma=-0.15\cdot{T_m}+1.66}$.
...
\begin{figure}
  ...
  \caption{\textbf{(a)} Modelled growth and decay of the last Cordilleran ice
           ...
           \todo{X-tick snapshot times on time series plot and thicken the
                 vertical lines. Add (a) and (b) subfigure labels. Link lower
                 and upper panels; see recipe at
                 \url{http://stackoverflow.com/questions/17543359/}.}}
