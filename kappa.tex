...
often only had local or regional relevance, and thus the Cordilleran ice sheet
remains the least understood Pleistocene ice sheet in terms of its extent,
volume, and dynamics.

In this thesis, I present numerical simulations performed with the Parallel Ice
Sheet Model (PISM), that allow quantitative reconstructions of the former ice
...
However, this maximum stage appear short-lived and out of balance with
...
glaciation including isolated glaciers and ice caps covering the major mountain
ranges, the largest of which is located over the Skeena Mountains. Numerically
modelled patterns of ice sheet growth and decay are diverse, and reveal a
higher complexity than that encapsulated in previous, conceptual models.
