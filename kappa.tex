...
\begin{figure}
  ...
  \caption{Contrasted climates of the North American Cordillera.
           \textbf{(a)} Pacific Coast at Vancouver Island.
           \textbf{(b)} Fraser Valley, south-central British Columbia.}
...
conductivity. Constant parameters of the ice flow model use in this thesis are
...
approximations of ice flow equations: the shallow ice approximation
    \citep[SIA,][]{Morland.Johnson.1980, Hutter.1983}
and the the shallow shelf approximation
    \citep[SSA,][]{Morland.1987, Weis.etal.1999}.
Although both approximations can be derived
...
\todo{Add a few words about the fact that $\vsia$ can be directly obtained
...
PDDs are use to melt ice, using a proportionality factor $F_i$
...
corrections derived from different palaeo-temperature proxy records. All data
