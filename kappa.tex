...
orogenic belt. Major ice-covered reliefs include,
...
linear Rocky Mountain / Tintina Trench. It includes the Selwyn and
...
the major topographical troughs, and sometimes flowing across them \mref. In
terms of
...
above 40\,\degC\ in the polar interior (\cref{fig:plot-atm}b). There exist a
...
the year (\cref{fig:plot-atm}d). Coastal regions experience most precipitation
during winter and fall, thus as snow. On the contrary, many inland regions
experience dry winters, and most of the annual precipitation consequently falls
...
USA and Alaska (\cref{map-cordillera}). The southern margin is the most
...
Glacial Lake Missoula \mref. As the ice sheet retreated, the lake repeatedly
and catastrophically drained to the Pacific Ocean \mref. These floods
contributed to shape a distinctive landscape known as the Channeled Scablands.
