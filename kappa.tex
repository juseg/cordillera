...
\begin{description}
  ...
  \item[\CCYC] \bibentry{Seguinot.etal.inpreparation}
\end{description}
...
% meters sea-level 58.3 + 7.36 = 65.6
...
During the last glacial maximum, apex of glaciation, three major ice sheets had
...
are the degree-day factors for snow, $F_s$, and ice, $F_i$, and the standard
deviation of near-surface air temperature, $\sPDD$. Although the first two can
only be deduced from laborious surface mass-balance measurements on present-day
glaciers \citep[e.g.,][]{Shea.etal.2009}, $\sPDD$ can be estimated from
temperature time-series \citep[e.g.,][]{Fausto.etal.2011}.
...
\noindent\textbf{\CCYC} --- \bibentry{Seguinot.etal.inpreparation}
\bigskip
