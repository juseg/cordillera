...
The North American Cordillera is an immense maze of mountain ranges and
intermontane basins which once hosted an ice mass comparable to Greenland: the
...
distribution of temperature and precipitation in the region combined with
paleoclimate reconstructions, provided an
...
numerical ice sheet modelling with analysis of geological evidence in order to
improve our understanding of former glaciations.
...
\begin{description}
  ...
  \item[\CCYC] \bibentry{Seguinot.etal.manuscript}.
\end{description}
