...
%%%
      ...
      (Fig.~\ref{fig:lr_ts}, upper panel), model output presents
   ...
   \subsection{Extreme configurations}
      ...
      Fig.~\ref{fig:lr_maps}, lower panels) invariably include
...
\label{sec:timing}
      ...
      deglaciation (Fig.~\ref{fig:lr_ts}) following its last glacial
...
\subsubsection{Transient ice sheet states}
      ...
      ice cover throughout the last glacial cycle (Fig.~\ref{fig:hr_geom_duration}).
      ...
      timespan of the last glacial cycle (Fig.~\ref{fig:hr_geom_duration}, hatched
      ...
      entire simulation period (Fig.~\ref{fig:hr_geom_duration}, AR). This apparent
...
\subsubsection{Major ice-dispersal centres}
      ...
      (Fig.~\ref{fig:hr_geom_duration}), are located over the Coast Mountains (CM),
      ...
      (Fig.~\ref{fig:hr_geom_duration}, NRM) do not act as a~nucleation centre, but
      ...
      (Figs.~\ref{fig:lr_maps} and~\ref{fig:hr_geom_duration}, SM). Regardless of
...
\subsubsection{Erosional imprint on the landscape}
      ...
      Mountains (Figs.~\ref{fig:hr_geom_duration} and \ref{fig:hr_geom_warmbase};
      ...
      (Fig.~\ref{fig:hr_geom_duration}) associated with basal ice temperatures at
      the pressure melting point (Figs.~\ref{fig:hr_geom_warmbase}
      and~\ref{fig:hr_geom_warmfrac}) explains the large-scale glacial erosional
      ...
      predominantly warm-based ice (Fig.~\ref{fig:hr_geom_warmfrac}). However,
      because it is only glaciated for a~short fraction of the last glacial
      cycle in our simulations (Fig.~\ref{fig:hr_geom_duration}), this perhaps
      ...
      (Figs.~\ref{fig:hr_geom_warmbase} and~\ref{fig:hr_geom_warmfrac}) is inevitably
...
\subsection{The last deglaciation}
   ...
   \subsubsection{Pace and patterns of deglaciation}
      ...
      and~\ref{fig:hr_geom_deglacage}). The southern sector of the modelling domain,
   ...
   \subsubsection{Late-glacial readvance}
      ...
      Finlay River area in the Omenica Mountains (Fig.~\ref{fig:hr_geom_deglacage}, OM)
      ...
      (Fig.~\ref{fig:hr_geom_deglacage}, left panel). In addition to matching the
      ...
      of the Saint Elias and the Coast mountains (Fig.~\ref{fig:hr_geom_deglacage},
      right panel).
   ...
   \subsubsection{Deglacial flow directions}
      ...
      a~cold-based retreating margin (Fig.~\ref{fig:hr_geom_lastflow}). The modelled
      ...
      (Fig.~\ref{fig:hr_geom_lastflow}, hatched areas). This notably includes parts
      ...
      numerical modelling (Fig.~\ref{fig:hr_geom_lastflow}). In the northern half of
      ...
      Liard Lowland, for instance (Fig.~\ref{fig:hr_geom_lastflow}), closely
      ...
      deglaciation (Fig.~\ref{fig:hr_geom_lastflow}). Yet, the Interior Plateau also
      ...
      basal sliding (Fig.~\ref{fig:hr_geom_lastflow}). Thus, a~second explanation
      ...
      southwards-flowing non-sliding ice lobes (Fig.~\ref{fig:hr_geom_lastflow})
      positioned in-between deglaciated mountain ranges
      (Figs.~\ref{fig:hr_pf_grip} and~\ref{fig:hr_pf_epica}). This
