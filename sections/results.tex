...
\begin{figure*}[t]
	...
	\label{fig:cool06}
  \arjen[inline]{Why do you inconsistently use K and degrees C?}
\end{figure*}
...
\begin{figure*}[t]
  ...
  \arjen[inline]{I think just removing "1" is enough. No other number are in need of moving I think.}
...
\begin{figure}[t]
  ...
  \arjen[inline]{The shape of these are modulated by the modelling domain. It looks as if the curves are at maximum difference for 5-6 degrees C and are closer again 7-9 degrees C, but perhaps the latter is an artefact from the fact that the ice sheets cannot grow beyond the domain boundaries?}
